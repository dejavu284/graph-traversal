...
"color: white")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rangLine.sizePolicy().hasHeightForWidth())
        self.rangLine.setSizePolicy(sizePolicy)
...
"color: white")
        ...
        self.verticalLayout_3.addWidget(self.rangLine)
